...
![Version: 0.5.33-rc02](https://img.shields.io/badge/Version-0.5.33--rc02-informational?style=flat-square) ![AppVersion: 2022.12.0](https://img.shields.io/badge/AppVersion-2022.12.0-informational?style=flat-square)
...
To install the chart with the release name `my-release` at version 0.5.33-rc02:
...
helm upgrade --install --devel my-release rstudio/rstudio-workbench --version=0.5.33-rc02
```

To explore other chart versions, take a look at:
```
helm search repo --devel rstudio/rstudio-workbench -l
```
