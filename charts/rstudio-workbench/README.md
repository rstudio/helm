...
![Version: 0.5.0-rc07](https://img.shields.io/badge/Version-0.5.0--rc07-informational?style=flat-square) ![AppVersion: 2021.09.0-351.pro6](https://img.shields.io/badge/AppVersion-2021.09.0--351.pro6-informational?style=flat-square)
...
To install the chart with the release name `my-release` at version 0.5.0-rc07:

```bash
helm repo add rstudio https://helm.rstudio.com
helm install my-release rstudio/rstudio-workbench --version=0.5.0-rc07
```
