...
| pod.lifecycle | object | `{"preStop":{"command":["/opt/rstudio-pm/bin/license-manager","deactivate","--userspace"]}}` | Container [lifecycle hooks](https://kubernetes.io/docs/concepts/containers/container-lifecycle-hooks/) |
