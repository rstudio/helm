...
![Version: 0.20.5](https://img.shields.io/badge/Version-0.20.5-informational?style=flat-square) ![AppVersion: 2026.09.0](https://img.shields.io/badge/AppVersion-2026.09.0-informational?style=flat-square)
...
helm upgrade --install my-release rstudio/rstudio-pm --version=0.20.5
```
