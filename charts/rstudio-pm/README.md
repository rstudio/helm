...
Package Manager can be configured to store data in S3 buckets (see the [Adming Guide](https://docs.rstudio.com/rspm/admin/files-directories/#data-destinations)
