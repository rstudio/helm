...
| image.tagPrefix | string | `"jammy-"` | A tag prefix for the server image (common selections: bionic-, ubuntu2204-). Only used if tag is not defined |
...
| launcher.defaultInitContainer.tagPrefix | string | `"jammy-"` | A tag prefix for the Content InitContainer image (common selections: bionic-, ubuntu2204-). Only used if tag is not defined |
