...
![Version: 0.7.21](https://img.shields.io/badge/Version-0.7.21-informational?style=flat-square) ![AppVersion: 2025.01.0](https://img.shields.io/badge/AppVersion-2025.01.0-informational?style=flat-square)
...
To install the chart with the release name `my-release` at version 0.7.21:

```{.bash}
helm repo add rstudio https://helm.rstudio.com
helm upgrade --install my-release rstudio/rstudio-connect --version=0.7.21
```
