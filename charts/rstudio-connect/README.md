...
![Version: 0.3.17](https://img.shields.io/badge/Version-0.3.17-informational?style=flat-square) ![AppVersion: 2023.01.1](https://img.shields.io/badge/AppVersion-2023.01.1-informational?style=flat-square)
...
To install the chart with the release name `my-release` at version 0.3.17:

```bash
helm repo add rstudio https://helm.rstudio.com
helm install my-release rstudio/rstudio-connect --version=0.3.17
```
