...
| backends.kubernetes.enabled | bool | `false` | Whether to enable the native Kubernetes implementation of off-host execution for running content-jobs in remote Kubernetes pods. |
