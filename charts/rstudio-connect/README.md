...
![Version: 0.8.39](https://img.shields.io/badge/Version-0.8.39-informational?style=flat-square) ![AppVersion: 2038.01.19](https://img.shields.io/badge/AppVersion-2038.01.19-informational?style=flat-square)
...
To install the chart with the release name `my-release` at version 0.8.39:

```{.bash}
helm repo add rstudio https://helm.rstudio.com
helm upgrade --install my-release rstudio/rstudio-connect --version=0.8.39
```
