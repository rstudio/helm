...
![Version: 0.2.37](https://img.shields.io/badge/Version-0.2.37-informational?style=flat-square) ![AppVersion: 2022.06.0](https://img.shields.io/badge/AppVersion-2022.06.0-informational?style=flat-square)
...
To install the chart with the release name `my-release` at version 0.2.37:

```bash
helm repo add rstudio https://helm.rstudio.com
helm install my-release rstudio/rstudio-connect --version=0.2.37
```
