...
# Configuring Posit Workbench with Azure Application Gateway Ingress
...
The focus of this example is on Azure Application Gateway Ingress setup, however there are a few requirements to run Workbench.
